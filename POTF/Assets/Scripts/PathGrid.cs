...
public class PathGrid<TGridObject>
{
    ...
    public PathGrid(int width, int height, float cellSize, Vector3 originPosition, Func<PathGrid<TGridObject>, int, int, TGridObject> createGridObject, bool showDebug = false)
    {
        this.width = width;
        this.height = height;
